...
# The message to display on the startup screen
startmessage = 'Press  \'S\' to start\n \n Press spacebar \
to fire\n \nUse arrowkeys to move\n \nSelect your level.\n\'Q\' (EASY), \
\'W\' (MEDIUM), \'E\' (DIFFICULT)'
# The message to display when a life is lost
pausemessage = 'YOU LOST A LIFE!\nLUCKILY, YOUR DAD IS RICH \n \
 \nPRESS \'S\' TO ASK FOR A NEW SHIP'
# The message to display when the player wins
winmessage = 'Aliens defeated!\nYour planet is saved.\n \nYOU WIN'
# The message to display when the player loses
losemessage = 'You lose.\nHow embarrassing.'
# The color of the defense line
DLINE_COLOR = introcs.RGB(128, 55, 55)
# The number of waves in the game
GAME_WAVES = 3
# The factor by which to multiply alien speed for each alien destroyed
SPEED_MULT = 0.977
# The color of the win message
CYAN = introcs.RGB(0, 255, 106)
# The color of the medium difficulty selection indicator
ORANGE = introcs.RGB(255, 72, 0)
# The time between alien steps for the easiest difficulty
EASY = ALIEN_SPEED
# The time between alien steps for the medium difficulty
MEDIUM = ALIEN_SPEED*0.75
# The time between alien steps for the hard difficulty
HARD = ALIEN_SPEED*0.5
